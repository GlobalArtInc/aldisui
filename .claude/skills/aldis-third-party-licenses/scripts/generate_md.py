...
def render_summary(deps_by_ecosystem: dict) -> str:
    ...
    lines.append("distributed with Aldis UI, grouped by ecosystem.\n\n")
...
def main():
    ...
    out.append(
        "Aldis UI is built on the work of many open-source projects. "
        "This document identifies every third-party component distributed "
        "with Aldis UI, in compliance with the attribution requirements "
    ...
    out.append(render_ecosystem(
        ...
        "Modules statically linked into the Aldis UI server binary. "
