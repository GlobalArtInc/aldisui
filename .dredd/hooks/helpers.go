...
import (
	...
	proFeatures "github.com/GlobalArtInc/aldisui/pro/pkg/features"
...
func loadConfig() {
	...
	// test gets the same whitelist from ALDIS_APPS in server-wrapper.sh,
