...
func TestLdapProfileMatchesAldisUser(t *testing.T) {
	aldisUser := db.User{Username: "jdoe", Email: "jdoe@example.com"}

	assert.True(t, ldapProfileMatchesAldisUser(
	...
	assert.False(t, ldapProfileMatchesAldisUser(
