...
import (
	...
	"github.com/GlobalArtInc/aldisui/pkg/git"
...
type Template struct {
	...
	// Name as described in https://github.com/GlobalArtInc/aldisui/issues/188
	Name string `db:"name" json:"name"`
	// playbook name in the form of "some_play.yml"
	Playbook string `db:"playbook" json:"playbook"`
	// to fit into []string
	Arguments *string `db:"arguments" json:"arguments,omitempty"`
	// if true, aldis will not prepend any arguments to `arguments` like inventory, etc
