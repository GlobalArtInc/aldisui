...
func TestValidateGitURL(t *testing.T) {
	tests := []struct {
		...
		{"https", "https://github.com/GlobalArtInc/aldisui.git", false},
		{"http", "http://example.com/repo.git", false},
		{"ssh scheme", "ssh://git@example.com/repo.git", false},
		{"scp-like ssh", "git@github.com:GlobalArtInc/aldisui.git", false},
...
func TestRepositoryValidate_AcceptsNormalURL(t *testing.T) {
	repo := Repository{
		Name:      "ok",
		GitURL:    "https://github.com/GlobalArtInc/aldisui.git",
		GitBranch: "main",
		SSHKeyID:  1,
	}
