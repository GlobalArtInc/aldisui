...
func TestGetEnvironmentVars(t *testing.T) {
	os.Setenv("ALDIS_TEST", "test123")  //nolint:errcheck
	os.Setenv("ALDIS_TEST2", "test222") //nolint:errcheck
	os.Setenv("PASSWORD", "test222")        //nolint:errcheck

	util.Config = &util.ConfigType{
		ForwardedEnvVars: []string{"ALDIS_TEST"},
...
func TestGetHomeDir(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			tmpPath:      "/tmp/aldis",
			expectedHome: "/tmp/aldis/project_42",
