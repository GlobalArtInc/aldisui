...
// legacyEncrypt simulates how the OLD Aldis stored a secret: AES-GCM with the
...
// TestLegacyFlatKey_DecryptsAllKeyTypes verifies that data written by old Aldis
