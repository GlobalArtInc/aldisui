...
import (
	...
	"github.com/GlobalArtInc/aldisui/services/tasks/hooks"
...
type TaskRunner struct {
	...
	// job executes Ansible and returns stdout to Aldis logs
	job Job
...
func (t *TaskRunner) run() {
	...
	// can be exposed to the playbook as ALDIS_JWT. Remote runners receive
