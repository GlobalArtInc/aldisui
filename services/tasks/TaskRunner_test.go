...
func TestTaskGetPlaybookArgs(t *testing.T) {
	...
	if res != "-i /tmp/project_0/inventory_0 --extra-vars {\"aldis_vars\":{\"task_details\":{\"commit_hash\":null,\"commit_message\":\"\",\"id\":0,\"inventory_id\":0,\"inventory_name\":\"\",\"repository_id\":0,\"repository_name\":\"\",\"url\":null,\"username\":\"\"}}} test.yml" {
