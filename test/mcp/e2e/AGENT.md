...
1. Use Playwright MCP (NOT Aldis MCP!) to execute the cases in `test_plan.md` in **headless mode** (do not show a browser window).
...
- **Aldis context**: `<base URL / instance name / version if known>`
- **MCP servers used**: `aldis`, `playwright` (as applicable)
