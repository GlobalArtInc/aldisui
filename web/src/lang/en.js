export default {
  ...
  firstlyYouNeedAccessToTheServerWhereAldisRunni:
    'Firstly, you need access to the server where Aldis running.',
  executeTheFollowingCommandOnTheServerToSeeExisting:
    'Execute the following command on the server to see existing users:',
  aldisUserList: 'aldis user list',
  youCanChangePasswordOfExistingUser: 'You can change password of existing user:',
  aldisUserChangebyloginLoginUser123Password:
    'aldis user change-by-login --login user123 --password {makePasswordExample}',
  ...
  workflowArtifactsRemoteRunnerWarning: 'This run contains tasks executed by remote runners. Workflow artifacts (set_stats values) will not flow across remote-runner steps yet — they are only passed between tasks executed locally on the Aldis server.',
