export default {
  ...
  firstlyYouNeedAccessToTheServerWhereAldisRunni: 'In primo luogo, è necessario avere accesso al server in cui è in esecuzione Aldis.',
  ...
  ansibleAldis: 'Interfaccia utente Aldis',
