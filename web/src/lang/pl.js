export default {
  ...
  firstlyYouNeedAccessToTheServerWhereAldisRunni: 'Po pierwsze, musisz mieć dostęp do serwera, na którym działa Aldis.',
  ...
  dashboard2: 'Panel',
  ansibleAldis: 'Interfejs użytkownika Aldis',
