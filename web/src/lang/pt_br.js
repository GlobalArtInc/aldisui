export default {
  ...
  firstlyYouNeedAccessToTheServerWhereAldisRunni: 'Primeiro, você precisa de acesso ao servidor onde o Aldis está em execução.',
  ...
  dashboard2: 'Painel',
  ansibleAldis: 'Interface do Aldis',
