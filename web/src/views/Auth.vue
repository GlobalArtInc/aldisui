  ...
  <div class="auth">
    <v-dialog v-model="loginHelpDialog" max-width="600">
      <v-card>
        ...
        <v-card-text>
          <p class="text-body-1">
            {{ $t('firstlyYouNeedAccessToTheServerWhereAldisRunni') }}
          </p>
          <p class="text-body-1">
          ...
          <v-alert dense text color="info" style="font-family: monospace">
            {{
              $t('aldisUserChangebyloginLoginUser123Password', {
          ...
          <v-alert dense text color="info" style="font-family: monospace">
            aldis user add --admin --login user123 --name User123 --email user123@example.com
